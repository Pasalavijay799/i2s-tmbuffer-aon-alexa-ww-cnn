//! Auto Generated on  07_08_2026_12_54_35_.  Version: 9.1.3-dirty
//! Do Not Modify this file!!
//! ---------------------------------------------------------------------------------------------

//! Gpx-Utils Command:
//! gpx-utils.exe  --EmitModelConfig --OPMWidth=16 --WTMWidth=16 --BT=S7 --InputModelType=CNN --packer_out=-1 --shiftAlgorithm=ArmShift,ArmShift C:\AmbientScientific\setup\chip\fw\applications\i2s-tmbuffer-aon-alexa-ww-cnn\test\temp\GC_07_08_2026_12_53_55\final_try.onnx.mlir C:\AmbientScientific\setup\chip\fw\applications\i2s-tmbuffer-aon-alexa-ww-cnn\test\temp\GC_07_08_2026_12_53_55\wake-word-model.onnx.mlir -o C:\AmbientScientific\setup\chip\fw\applications\i2s-tmbuffer-aon-alexa-ww-cnn\i2s-tmbuffer-aon-alexa-ww-cnn\ 
...
uint16_t* v_INPUTS_PAD =  0;
uint16_t* v_OUTPUTS =  0;
...
extern void write_wtm_1(int64_t val);
extern void write_pregs_1(int64_t val);
extern void wr_generic_ucode_1(int64_t val);

void (*wtm_ptr[])(int64_t) = {write_wtm_0,write_wtm_1};
void (*preg_ptr[])(int64_t) = {write_pregs_0,write_pregs_1};
void (*ucode_ptr[])(int64_t) = {wr_generic_ucode_0,wr_generic_ucode_1};
